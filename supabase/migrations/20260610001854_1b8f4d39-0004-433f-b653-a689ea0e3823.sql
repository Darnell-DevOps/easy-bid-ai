...
-- Replace test function with proposal inserts that include all required columns.
...
BEGIN
  ...
  INSERT INTO public.automation_preferences (user_id, preferences) VALUES (_user_id, '{}'::jsonb)
  ...
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope, status)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker, 'draft') RETURNING id INTO v_prop_id;
  SELECT count(*) INTO v_count FROM public.proposals WHERE id = v_prop_id AND status = 'sent';
  v_pass := v_count = 1;
  ...
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker) RETURNING id INTO v_prop_id;
  ...
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope, timeline)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker, '30 days') RETURNING id INTO v_prop_id;
  ...
  SELECT count(*) INTO v_count FROM public.user_notifications WHERE key = 'proposal_viewed' AND (metadata->>'proposal_id')::uuid = v_prop_id;
  v_pass := v_count = 1;
  ...
  -- PROPOSAL_NOTIFY_EXPIRED
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope, status, sent_at)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker, 'sent', now() - interval '20 days')
  ...
  SELECT count(*) INTO v_count FROM public.user_notifications WHERE key = 'proposal_expired' AND (metadata->>'proposal_id')::uuid = v_prop_id;
  v_pass := v_count = 1;
  DELETE FROM public.user_notifications WHERE (metadata->>'proposal_id')::uuid = v_prop_id;
  ...
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope, amount_cents, currency, status)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker, 50000, 'USD', 'sent') RETURNING id INTO v_prop_id;
  ...
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 10000, 'USD', 'sent', marker || '-tok1')
  ...
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 10000, 'USD', 'sent', marker || '-tok2')
  RETURNING id INTO v_contract_id;
  INSERT INTO public.deadlines (user_id, contract_id, client_name, title, due_date, source, source_key)
  VALUES (_user_id, v_contract_id, marker, 'CFU', current_date, 'contract_follow_up', 'cfu-' || v_contract_id::text);
  ...
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 10000, 'USD', 'sent', marker || '-tok3')
  RETURNING id INTO v_contract_id;
  ...
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 10000, 'USD', 'sent', marker || '-tok4')
  RETURNING id INTO v_contract_id;
  ...
  -- PAYMENT_AUTO_REQUEST
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 50000, 'USD', 'sent', marker || '-tok5')
  RETURNING id INTO v_contract_id;
  ...
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 50000, 'USD', 'sent', marker || '-tok6')
  RETURNING id INTO v_contract_id;
  ...
  -- PAYMENT_AUTO_CONFIRMATION (intent flag in returned jsonb)
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope, amount_cents, currency)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker, 1000, 'USD') RETURNING id INTO v_prop_id;
  ...
  v_pass := COALESCE((public.automations_handle_payment_event(_user_id, 'proposal_paid', v_prop_id, NULL, 1000, 'USD') ->> 'payment_auto_confirmation')::boolean, false);
  ...
  results := results || jsonb_build_object('payment_auto_confirmation',
    v_pass AND public.automations_handle_payment_event(_user_id, 'proposal_paid', v_prop_id, NULL, 1000, 'USD') ->> 'payment_auto_confirmation' IS NULL);
  DELETE FROM public.user_notifications WHERE (metadata->>'proposal_id')::uuid = v_prop_id;
  DELETE FROM public.deadlines WHERE proposal_id = v_prop_id;
  ...
  -- PAYMENT_FOLLOW_UP_UNPAID (tick + overdue retainer invoice)
  INSERT INTO public.retainers (user_id, client_id, client_name, service_type, amount_cents, currency, status, billing_cycle)
  VALUES (_user_id, v_client_id, marker, marker, 10000, 'USD', 'active', 'monthly') RETURNING id INTO v_retainer_id;
  ...
  PERFORM public.automations_run_user_ticks(_user_id);
  SELECT count(*) INTO v_count FROM public.deadlines WHERE user_id = _user_id AND source = 'invoice_followup' AND client_name = marker;
  v_pass := v_count >= 1;
  DELETE FROM public.deadlines WHERE user_id = _user_id AND source = 'invoice_followup' AND client_name = marker;
  ...
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 0, 'USD', 'sent', marker || '-tok7')
  RETURNING id INTO v_contract_id;
  ...
  INSERT INTO public.contracts (user_id, client_id, client_name, contract_type, title, body, amount_cents, currency, status, signing_token)
  VALUES (_user_id, v_client_id, marker, 'service_agreement', marker, 'body', 0, 'USD', 'sent', marker || '-tok8')
  RETURNING id INTO v_contract_id;
  ...
  -- DEADLINES_FROM_PROPOSALS
  INSERT INTO public.proposals (user_id, client_id, client_name, company_name, service_type, project_scope, timeline, status)
  VALUES (_user_id, v_client_id, marker, marker, marker, marker, '30 days', 'sent') RETURNING id INTO v_prop_id;
