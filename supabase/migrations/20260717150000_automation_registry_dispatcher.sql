...
-- The matching CRON_SECRET must be stored both as an Edge Function secret and
-- in Vault under the name cron_secret. Dynamic SQL keeps this migration valid
-- before the deployment secret is added.
