import { Check, FileText, FileSignature, CreditCard, CalendarCheck, ClipboardList, Rocket } from "lucide-react";
...
const STAGES: { id: FullStage; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
  { id: "proposal", label: "Proposal", icon: FileText },
  { id: "contract", label: "Contract", icon: FileSignature },
  { id: "payment", label: "Payment", icon: CreditCard },
  { id: "booking", label: "Booking", icon: CalendarCheck },
  { id: "onboarding", label: "Onboarding", icon: ClipboardList },
  { id: "ready", label: "Project Ready", icon: Rocket },
];

const ORDER: Record<FullStage, number> = {
  proposal: 0,
  contract: 1,
  payment: 2,
  booking: 3,
...
export default function OnboardingProgressTracker({ currentStage, className, compact }: Props) {
