...
import { FileText, Plus, CreditCard, Settings, LogOut, Menu, X, LayoutTemplate, Users, Sparkles, ScrollText } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <main className="flex-1 md:pt-0 pt-14 overflow-auto">
        <div className="p-6 md:px-10 md:py-8 max-w-7xl content-glow">{children}</div>
      </main>
    </div>
  );
}
